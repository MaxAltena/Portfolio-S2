...
<html lang="nl">
    ...
    <body>
        ...
        <main>
                        ...
                        <script>
                            ...
                            function imageSlider(x){
                              ...
                              $('#image').fadeTo(250, 0, function(){
                                $(this).css('background-image', 'url(/assets/media/' + images[index - 1] + ')');
                              }).fadeTo(250, 1);
                            }
                        </script>
            <?php
            ...
            ?>
                        <script>
                            $("#image").css({"background-image": "url(/assets/media/<?= $image; ?>)"});
                        </script>
            <?php
                    }
            ?>
                    <script>
                        $("#editButton").css({right: "26%"});
                    </script>
                </div>
            <?php
                }
            ...
            ?>
                    <a href="/assets/media/<?= $document; ?>" id="document" target="_blank">
            ...
            <?php
                ...
                if ($currentItem['video'] !== null) {
                    ...
                    $video = $result['name'];
            ?>
                    <a href="/assets/media/<?= $video; ?>" id="video" target="_blank">
            ...
            ?>
                            <a href="/item?i=<?= $result[0]['name']; ?>" class="aLink">
            ...
            ?>
            <div id="bottom">
                <a href="/categorie?c=<?= $currentCategory['short']; ?>" class="bLink">
