...
<html lang="nl">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/sprint1/css/indexstyle.css">
    </head>
    ...
    <body>
        ...
        <main>
            ...
            <div id="home">
                ...
                <img src="/sprint1/assets/max.png" alt="Profielfoto" id="profilephoto" />
            </div>
            <div id="categories">
                <?php
