<html lang="nl">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/sprint1/documentatie/style.css">
        <script src="/sprint1/documentatie/script.js"></script>
    </head>

    <body>
        <div id="backButton"><a href="/sprint1/">← terug naar website</a></div>
        <nav>
            <div id="mainNAV">
