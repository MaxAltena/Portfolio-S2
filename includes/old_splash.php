...
<div id="splash">
    <div id="splash_canvas">
        ...
        <textarea id="code_canvas" onkeyup="activeLine();" onmouseup="this.onkeyup();"><?php include_once($_SERVER['DOCUMENT_ROOT'] . '/includes/zelfportret.txt'); ?></textarea>
    </div>
    <div id="splash_grid">
        <div id="splash_name">
...
<script>
    $(document).ready(function(){
        $("#splash_grid").on({
            mouseenter: function(){
                $("#splash_zelfportretClick .text").css({transition: "0.5s", transform: "scale(1.25,1.25)", "text-decoration": "underline"});
            },
            mouseleave: function(){
                $("#splash_zelfportretClick .text").css({transition: "0.5s", transform: "scale(1,1)", "text-decoration": "none"});
            },
            click: function(){
                open();
            }
