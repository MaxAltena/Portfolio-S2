...
<div id="splash">
    <div id="splash_canvas">
        ...
        <textarea id="code_canvas" onkeyup="activeLine();" onmouseup="this.onkeyup();"><?php include_once("text.txt"); ?></textarea>
    </div>
    <div id="splash_grid">
        <div id="splash_name">
...
<script>
    $(document).ready(function(){
        ...
        function reset(){
            fetch("/includes/text.txt").then(response=>response.text()).then(text=>$("#code_canvas").val(text));
            
            setTimeout(lineCount, 50);
        }
