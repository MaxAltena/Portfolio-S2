                ...
                $.each(searchResults, function(index, value) {
                        if (value.substring(0, 3) == "CN:"){
                            ...
                            $.ajax({
                                ...
                                cache: false,
                                success: function(data){
                                    searchResults[index] = "<a href='/sprint4/categorie?c=" + data + "' class='searchLink'>" + boldedText + "</a>";
                                }
                            });
                        }
                            ...
                            searchResults[index] = "<a href='/sprint4/categorie?c=" + subValue[1] + "' class='searchLink'>" + boldedText + "</a>";
                        }
                            ...
                            searchResults[index] = "<a href='/sprint4/item?i=" + subValue[1] + "' class='searchLink'>" + boldedText + "</a>";
                        }
                        index = index + 2;
                    });
