    ...
    <div class="gridContent listContent">
        <div class="filterList">
            ...
            <div class="filterSpotlight">
                ...
                <p class="filterPlist"><span class="filterOptionSpotlight activeFilterSpotlight" id="filterSpotlightAlles">Alles</span><span class="filterOptionSpotlight" id="filterSpotlight0">0</span><span class="filterOptionSpotlight" id="filterSpotlight1">1</span></p>
            </div>
            <script>
                            ...
                            if (confirm("Weet je zeker dat je dit item wilt wijzigen?")){
                                ...
                                $.ajax({
                                    ...
                                    success: function(result){
                                        ...
                                        setTimeout(function(){
                                            $("#content").load("/sprint4/admin/pages/list").show("slide", { direction: "left" }, 500);
                                        }, 500);
                                    }
                                });
                            }
