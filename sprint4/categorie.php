...
<html lang="nl">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/sprint4/css/categoriestyle.css">
    </head>
    ...
    <body>
        ...
        <main>
            <div id="top">
                ...
                <div id="topRubrix">
                    <a href="/sprint4/rubrix?r=<?= $short; ?>" class="aLink">
                        <div id="rubrixLink">
        ...
        ?>
                    <a href="/sprint4/item?i=<?= $item['name']; ?>" class="aLink">
                ...
                <?php
                            ...
                            if ($photoInsert !== null) {
                ?>
                               <script>$("#itemLink<?= $highID; ?>").css({background: "url(/sprint4/assets/media/<?= $photoInsert; ?>)", 'background-position': "center center"})</script>
                <?php
                            }
                    }
                }
        ...
        ?>
                ...
                <?php
                            ...
                            if ($photoInsert !== null) {
                ?>
                               <script>$("#itemLink<?= $item['id']; ?>").css({background: "url(/sprint4/assets/media/<?= $photoInsert; ?>)", 'background-position': "center center"})</script>
                <?php
                            }
                        }
                        else {
        ...
        <script src="/sprint4/js/category.js"></script>
